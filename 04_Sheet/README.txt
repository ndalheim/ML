...
Das Programm kann für die verschiedenen Aufgaben in 3 Modi ausgeführt werden. 
Dieser wird mit dem ersten übergebenen Arugument bestimmt. ( folds, cv, weka )
...
Um die cross validation auszuführen:
------------------------------------
